                ...
                <ul className="cost-list">
                  {serviceType === "blogger" ? (
                    ...
                    <>
                      ...
                      <li>تجديد الدومين الخاص بالمنصة (حوالي 55<RiyalIcon size="0.75em" /> سنويًا)</li>
                      <li>
                        حسابات مطوري Apple وGoogle لنشر تطبيقَي الجوال، وتخص باقة "المميزة المتكاملة" فقط
                        (حوالي 370<RiyalIcon size="0.75em" /> سنويًا و95<RiyalIcon size="0.75em" /> لمرة واحدة
                        على الترتيب)
                      </li>
                    </>
                  ) : (
                ...
                <ol className="contract-points">
                  {serviceType === "pharmacy" ? (
                    ...
                    <>
                      ...
                      <li>
                        يلتزم صاحب المشروع بتوفير حسابات رسمية معتمدة باسمه لدى هيئة الزكاة والضريبة
                        والجمارك (منصة فاتورة) وهيئة الغذاء والدواء (منصة رصد) قبل بدء مرحلة الربط.
                        اعتماد الربط والموافقة عليه من الجهتين يخضع بالكامل لسياساتهما وإجراءاتهما،
                        وليس مسؤولية مقدم الخدمة. أي تأخير ناتج عن تأخر صاحب المشروع في استخراج هذه
