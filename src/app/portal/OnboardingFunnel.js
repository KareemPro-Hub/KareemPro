              ...
              <div className="notice" style={{ marginTop: "1.4rem", background: "rgba(255,255,255,0.04)", border: "1px solid var(--border)", color: "var(--muted)" }}>
                ...
                <ul className="cost-list">
                  {serviceType === "blogger" ? (
                    ...
                    <>
                      <li>
                        الاستضافة وقاعدة البيانات السحابية لبيانات الصيدلية (تبدأ مجانية وتُرفع السعة
                        تلقائيًا مع زيادة حجم المبيعات والمستخدمين)
                      </li>
                      <li>رسوم بوابة الدفع لو فُعّل تحصيل الاشتراك إلكترونيًا (حوالي 2.5–3٪ من كل عملية)</li>
                      ...
                      <li>
                        حسابات مطوري Apple وGoogle لنشر تطبيقَي الجوال، وتخص باقة "المميزة المتكاملة" فقط —
                        حساب Apple يُجدَّد سنويًا بتكلفة 99$ تقريبًا، وحساب Google رسوم لمرة واحدة فقط بتكلفة
                        25$ تقريبًا
                      </li>
                    </>
                  ) : (
                  ...
                  {serviceType === "pharmacy" ? (
                    ...
                    <>
                      ...
                      <li>
                        ...
                        والاتفاق عليه قبل توقيع العقد. أي ميزة غير مذكورة صراحة في الباقة تُعتبر خارج
                        النطاق.
                      </li>
                      <li>
                        ...
                        إلا بعد الاتفاق الكتابي عليها.
                      </li>
                      <li>
                        يلتزم صاحب المشروع بتجهيز حسابات الربط الرسمية المطلوبة باسمه لدى الجهات
                        الحكومية المعنية (كهيئة الزكاة والضريبة والجمارك وهيئة الغذاء والدواء) قبل بدء
                        مرحلة الربط. اعتماد الربط والموافقة عليه من هذه الجهات يخضع بالكامل لسياساتها
                        وإجراءاتها، وليس مسؤولية مقدم الخدمة. أي تأخير ناتج عن تأخر صاحب المشروع في
                        تجهيز هذه الحسابات لا يُحتسب على مقدم الخدمة، ولا يُعتبر إخلالًا بمواعيد
                        التسليم.
                      </li>
                      <li>
                      ...
                      <li>
                        لا تشمل قيمة الباقة أي رسوم خارجية مثل الاستضافة، الدومين، أو أي رسوم تفرضها
                        هيئة الزكاة والضريبة أو هيئة الغذاء والدواء على الحسابات الرسمية نفسها.
                      </li>
                      <li>
                        الدعم الفني بعد التسليم يشمل معالجة الأخطاء التقنية الناتجة عن التنفيذ لمدة 3
                        أشهر، ولا يشمل إضافة مزايا جديدة أو الدعم التشغيلي اليومي.
                      </li>
