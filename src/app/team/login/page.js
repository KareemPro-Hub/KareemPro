...
// Team members log in through their own, separate, dead-simple entry point
// (kareempro.com/team) — same email+password sign-in used everywhere else
// on the platform, just a different landing destination on success.
    ...
    <div className="admin-auth-page">
      ...
      <div className="admin-auth-content">
        ...
        <div className="admin-auth-card">
          <h1 className="title">
            بوابة <span className="g-text">فريق العمل</span>
          </h1>
          <p className="muted">سجّلي دخولك بالبريد الإلكتروني وكلمة السر.</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {status === "error" && (
              <div className="notice notice-error">البريد أو كلمة السر غير صحيحة.</div>
            )}
