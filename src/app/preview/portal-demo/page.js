// صفحة معاينة داخلية فقط — بيانات وهمية لعرض شكل لوحة صاحب المشروع بدون تسجيل دخول حقيقي.
...
export default function PortalPreviewPage() {
  ...
  return (
    <div className="shell">
      ...
      >
        🔍 معاينة داخلية — بيانات وهمية لعرض شكل بوابة صاحب المشروع، مش حساب حقيقي
      </div>
