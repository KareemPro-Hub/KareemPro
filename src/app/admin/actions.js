...
const SERVICE_TEMPLATES = {
    ...
    packages: [
      ...
      },
      {
        ...
        features: [
          ...
          "تسليم كامل الصلاحيات والوصول",
          "طريقة السداد: ثلاث دفعات — 500 ريال مقدم، 450 ريال بعد إعداد الصفحات الإلزامية، 450 ريال عند اكتمال نشر المقالات الخمسين.",
        ].join("\n"),
      },
    ],
  },
  ...
  articles: {
    ...
    packages: [
      {
        name: "باقة 30 مقالًا|كتابة ونشر مقالات احترافية لمدونتك",
        price: 650,
        original_price: 900,
        is_featured: false,
        features: [
          "**كتابة ونشر 30 مقالًا احترافيًا على مدونتك**",
          ...
          "نشر مقال واحد يوميًا فقط — إيقاع آمن يحمي تقييم المدونة",
          "خطة مواضيع وكلمات مفتاحية معدّة مسبقًا",
          "مدة التنفيذ: 30 يومًا من تاريخ نشر أول مقال",
          "متابعة مجانية معك في خطوات التقديم لأدسنس",
          "طريقة السداد: دفعتان — 350 ريال مقدم، 300 ريال عند نشر المقال الخامس عشر.",
        ].join("\n"),
      },
      {
        name: "باقة 60 مقالًا|كتابة ونشر مقالات احترافية لمدونتك",
        price: 1100,
        original_price: 1600,
        is_featured: true,
        features: [
          "**كتابة ونشر 60 مقالًا احترافيًا على مدونتك**",
          "بنفس مستوى وأسلوب المقالات التأسيسية التي سبق تسليمها",
          "صياغة مختصرة وقوية تناسب القارئ العربي ومحركات البحث",
          "تنويع بنية المقالات وزواياها ومواضيعها لمنع تكرار المحتوى",
          "نشر مقال واحد يوميًا فقط — إيقاع آمن يحمي تقييم المدونة",
          "خطة مواضيع وكلمات مفتاحية معدّة مسبقًا",
          "مدة التنفيذ: 60 يومًا من تاريخ نشر أول مقال",
          "متابعة مجانية معك في خطوات التقديم لأدسنس",
