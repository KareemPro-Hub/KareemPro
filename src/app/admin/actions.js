    ...
    packages: [
      {
        ...
        features: [
          ...
          "دعم فني عند التسليم",
          "طريقة السداد: خمس دفعات. كل دفعة 1,500 ريال.",
        ].join("\n"),
      },
      {
        ...
        features: [
          ...
          "إعدادات مخصصة للصيدلية",
          "طريقة السداد: خمس دفعات. كل دفعة 1,700 ريال.",
        ].join("\n"),
      },
      {
        ...
        features: [
          "كل مميزات الباقة الأساسية",
          "إدارة الفروع والمستودع",
          "تحويل المخزون بين الفروع",
          "الجرد والدفعات وتواريخ الصلاحية",
          "لوحة إدارة شاملة وتقارير مالية",
          "محاسبة المبيعات والمشتريات",
          "صلاحيات متعددة حسب الدور",
