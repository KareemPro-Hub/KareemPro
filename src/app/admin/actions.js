    ...
    packages: [
      {
        ...
        features: [
          ...
          "طريقة السداد: ثلاث دفعات. كل دفعة 250 ريال — مقدم، بعد إعداد الصفحات الإلزامية، وعند تسليم المدونة وكتابة المقالات التأسيسية.",
        ].join("\n"),
      },
      {
        ...
        features: [
          ...
          "إعداد الصفحات الإلزامية (من نحن، سياسة الخصوصية، اتصل بنا)",
          "تحسين السيو الأساسي (Meta tags، خريطة الموقع، Schema)",
          "**كتابة ونشر 50 مقالًا احترافيًا من فريقنا خلال 30 يوم عمل**",
          "تسليم المدونة كاملة جاهزة خلال 5 أيام عمل",
          "متابعة مجانية معك في التقديم لأدسنس بعد اكتمال نشر المقالات",
          "تسليم كامل الصلاحيات والوصول",
          "طريقة السداد: ثلاث دفعات — 450 ريال مقدم، 450 ريال بعد إعداد الصفحات الإلزامية، 400 ريال عند اكتمال نشر المقالات الخمسين.",
        ].join("\n"),
      },
    ],
  },
  // Article packages — a general-purpose, repeatable content service for any
  // client whose blog already exists (typically sold as a follow-on after a
  // blogger build). Every package name carries the word "مقال": packageTier()
  // in lib/timeline.js and detectServiceType() in the funnel both read the
  // package name to recognise this service, exactly like blogger does.
  articles: {
    projectTitle: "كتابة ونشر مقالات المدونة",
    packages: [
      {
        name: "باقة 30 مقال|كتابة ونشر مقالات احترافية لمدونتك",
        price: 650,
        original_price: 900,
        is_featured: false,
        features: [
          "**كتابة ونشر 30 مقال احترافي على مدونتك**",
          "بنفس مستوى وأسلوب المقالات التأسيسية التي سبق تسليمها",
          "صياغة مختصرة وقوية تناسب القارئ العربي ومحركات البحث",
          "تنويع بنية المقالات وزواياها ومواضيعها لمنع تكرار المحتوى",
          "نشر مقال واحد في اليوم فقط — إيقاع آمن يحمي تقييم المدونة",
          "خطة مواضيع وكلمات مفتاحية جاهزة قبل بدء النشر",
          "مدة التنفيذ: 30 يوم من تاريخ نشر أول مقال",
          "متابعة مجانية معك في خطوات التقديم لأدسنس",
          "طريقة السداد: دفعتان — 350 ريال مقدم، 300 ريال عند نشر المقال الخامس عشر.",
        ].join("\n"),
      },
      {
        name: "باقة 60 مقال|كتابة ونشر مقالات احترافية لمدونتك",
        price: 1100,
        original_price: 1600,
        is_featured: true,
        features: [
          "**كتابة ونشر 60 مقال احترافي على مدونتك**",
          "بنفس مستوى وأسلوب المقالات التأسيسية التي سبق تسليمها",
          "صياغة مختصرة وقوية تناسب القارئ العربي ومحركات البحث",
          "تنويع بنية المقالات وزواياها ومواضيعها لمنع تكرار المحتوى",
          "نشر مقال واحد في اليوم فقط — إيقاع آمن يحمي تقييم المدونة",
          "خطة مواضيع وكلمات مفتاحية جاهزة قبل بدء النشر",
          "مدة التنفيذ: 60 يوم من تاريخ نشر أول مقال",
          "متابعة مجانية معك في خطوات التقديم لأدسنس",
          "طريقة السداد: ثلاث دفعات — 400 ريال مقدم، 350 ريال عند المقال العشرين، 350 ريال عند المقال الأربعين.",
        ].join("\n"),
      },
      {
        name: "باقة 100 مقال|كتابة ونشر مقالات احترافية لمدونتك",
        price: 1750,
        original_price: 2500,
        is_featured: false,
        features: [
          "**كتابة ونشر 100 مقال احترافي على مدونتك**",
          "بنفس مستوى وأسلوب المقالات التأسيسية التي سبق تسليمها",
          "صياغة مختصرة وقوية تناسب القارئ العربي ومحركات البحث",
          "تنويع بنية المقالات وزواياها ومواضيعها لمنع تكرار المحتوى",
          "نشر مقال واحد في اليوم فقط — إيقاع آمن يحمي تقييم المدونة",
          "خطة مواضيع وكلمات مفتاحية جاهزة قبل بدء النشر",
          "مدة التنفيذ: 100 يوم من تاريخ نشر أول مقال",
          "متابعة مجانية معك في خطوات التقديم لأدسنس",
          "طريقة السداد: ثلاث دفعات — 650 ريال مقدم، 550 ريال عند المقال الخامس والثلاثين، 550 ريال عند المقال السبعين.",
        ].join("\n"),
      },
    ],
  },
    ...
    packages: [
      {
        ...
        features: [
          ...
          "إدارة الأصناف والمخزون والفروع",
          "تنبيهات النفاد وقرب انتهاء الصلاحية",
          "فواتير إلكترونية QR",
          "إدارة مشتريات وموردين ومرتجعات",
          "صلاحيات المستخدمين المتعددة حسب الدور",
          "الجرد والدفعات وتواريخ الصلاحية",
          "لوحة إدارة شاملة ومحاسبة للمبيعات والمشتريات",
          "دعم فني لمدة شهر بعد التسليم",
          "طريقة السداد: خمس دفعات. كل دفعة 2,000 ريال.",
        ].join("\n"),
      },
      {
        ...
        features: [
          ...
          "تطبيق جوال للآيفون والأندرويد لمتابعة المبيعات والتقارير",
          "إشعارات فورية للمخزون والمبيعات",
          "دعم فني لمدة 3 أشهر بعد التسليم",
          "طريقة السداد: خمس دفعات. كل دفعة 3,000 ريال.",
        ].join("\n"),
      },
      {
        ...
        features: [
          ...
          "تطبيق Mac وWindows للكاشير والإدارة والتقارير",
          "تطبيق iPad للاستخدام المرن داخل الصيدلية",
          "ربط كامل بين التطبيقات والبيانات",
          "دعم فني لمدة سنة كاملة بعد التسليم",
          "طريقة السداد: خمس دفعات. كل دفعة 4,000 ريال.",
        ].join("\n"),
      },
    ],
  },
