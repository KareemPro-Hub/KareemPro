    ...
    packages: [
      {
        ...
        features: [
          ...
          "إدارة الفروع والمستودع وتحويل المخزون بينها",
          "الجرد والدفعات وتواريخ الصلاحية",
          "لوحة إدارة شاملة ومحاسبة للمبيعات والمشتريات",
          "تقارير مخزون ومبيعات متقدمة",
          "دعم فني عند التسليم",
          "طريقة السداد: خمس دفعات. كل دفعة 2,000 ريال.",
        ].join("\n"),
      },
      {
        name: "الباقة المميزة المتكاملة|منصة متكاملة مع تطبيقين للجوال",
        price: 15000,
      ...
      },
      {
        ...
        is_featured: false,
        features: [
          "كل مميزات الباقة المميزة المتكاملة",
