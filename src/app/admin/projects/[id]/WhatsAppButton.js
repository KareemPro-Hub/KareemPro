...
// Send himself inside WhatsApp). Rendered only when the client has a phone.
//
...
export default function WhatsAppButton({ phone, text, label, small = false }) {
  ...
  return (
    ...
    >
      <svg width={small ? 14 : 16} height={small ? 14 : 16} viewBox="0 0 24 24" fill="currentColor">
      ...
      {copied ? "الرسالة اتنسخت أيضًا ✓" : label}
    </a>
  );
}
