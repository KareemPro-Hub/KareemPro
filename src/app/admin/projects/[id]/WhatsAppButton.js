...
const BUILDERS = {
  ...
  overduePayment: overduePaymentMessage,
  ...
  return (
    <>
      ...
      >
        ...
        {isPending ? "لحظة..." : label}
      </a>
      {error && <span style={{ fontSize: "11px", color: "#c81e3f" }}>{error}</span>}
    </>
  );
}
